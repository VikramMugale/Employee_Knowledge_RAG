...
class IngestionPipeline:
    """Orchestrates document parsing, hash idempotency, metadata enrichment, embedding, and indexing."""
    ...
    async def ingest_file(self, file_path: str, access_level: str = "PUBLIC_INTERNAL") -> Optional[Document]:
        """
        Ingest a file with SHA-256 idempotency.
        Parsed chunks are embedded with Gemini and written to both retrievers.
        """
        ...
        try:
            ...
            doc.lifecycle_state = DocumentState.INDEXED
